...
require('../deps/cookie-node').secret = '3365432071300366369689693202336';
...
HttpClient.prototype.broadcast = function(data, encoding) {
  this.server.broadcast(data, encoding, this._id);
};
